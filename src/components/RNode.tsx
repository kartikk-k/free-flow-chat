...
function RNode(props: NodeProps) {
            ...
            <div className='p-4 bg-white rounded-3xl min-w-2xl max-w-2xl relative outline-2 outline-black/15 hover:shadow-2xl duration-150 cursor-default'>
                ...
                <div className='flex flex-col gap-1'>
                    ...
                    <div className='flex items-center gap-2'>
                        <button className='drag-handle__rNode hover:bg-neutral-200 w-6 h-8 flex items-center justify-center rounded-md active:cursor-grabbing hover:cursor-grab'>
                    ...
                    <div className='ml-5 p-3 flex flex-col gap-7 select-text'>
                        ...
                        <p className='font-medium cursor-text'>
                            How to make a website? using React and Tailwind CSS
                        </p>
                ...
                <>
                    ...
                    <Handle type="target" position={Position.Top} id={'a3'} />
