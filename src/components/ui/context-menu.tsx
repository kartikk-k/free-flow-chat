    ...
    <ContextMenuPrimitive.Portal>
      <ContextMenuPrimitive.Content
        ...
        className={cn(
          ...
          "bg-[rgb(51,51,51,0.6)] backdrop-blur-sm border-none rounded-xl shadow-2xl",
          className
        )}
        {...props}
      />
  ...
  return (
    <ContextMenuPrimitive.Item
      ...
      className={cn(
        ...
        "text-white focus:bg-white/20 focus:text-white rounded-lg text-sm [&_svg:not([class*='text-'])]:text-white/70",
        className
      )}
      {...props}
    />
